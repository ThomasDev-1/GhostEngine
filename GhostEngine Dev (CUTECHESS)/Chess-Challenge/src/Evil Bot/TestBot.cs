...
public class TestBot : IChessBot
{
    ...
    public bool OutOfTime => searchTimer.MillisecondsElapsedThisTurn > maxTimePerMove && rootMove != Move.NullMove;
    ...
    public int NMSearch(int depth, int alpha, int beta, int searchPly, bool allowNull = true)
    {
        ...
        foreach (Move move in moves)
        {
            ...
            int Search(int newDepth, int newAlpha) => -NMSearch(newDepth, -newAlpha, -alpha, searchPly, allowNull);
