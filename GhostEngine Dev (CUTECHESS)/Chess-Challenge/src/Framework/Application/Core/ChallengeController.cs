...
namespace ChessChallenge.Application
{
    public class ChallengeController
    {
        ...
        public void StartNewGame(PlayerType whiteType, PlayerType blackType)
        {
            ...
            //board.LoadPosition("r1bqk2r/pppp1ppp/2n2n2/4p3/2B1P3/8/PPPP1PPP/RNBQK1NR w KQkq - 1 7");
        ...
        ChessPlayer CreatePlayer(PlayerType type)
        {
            return type switch
            {
                ...
                PlayerType.LiteBlue => new ChessPlayer(new LiteBlue(), type, GameDurationMilliseconds),
                PlayerType.BettyBot_V1 => new ChessPlayer(new BettyBot_V1(), type, GameDurationMilliseconds),
                PlayerType.BettyBot_V2 => new ChessPlayer(new BettyBot_V2(), type, GameDurationMilliseconds),
                PlayerType.BettyBot_V3 => new ChessPlayer(new BettyBot_V3(), type, GameDurationMilliseconds),
                PlayerType.BettyBot_V4 => new ChessPlayer(new BettyBot_V4(), type, GameDurationMilliseconds),
                PlayerType.BettyBot_V5 => new ChessPlayer(new BettyBot_V5(), type, GameDurationMilliseconds),
                PlayerType.BettyBot_V6 => new ChessPlayer(new BettyBot_LATEST(), type, GameDurationMilliseconds),
                PlayerType.GhostEngine_V1 => new ChessPlayer(new GhostEngine_V1(), type, GameDurationMilliseconds),
